...
import { create, loading, error } from '../../actions/newsarticle/create';
...
const mapStateToProps = (state) => {
  return {
    ...
    error: state.newsarticle.create.error,
    loading: state.newsarticle.create.loading,
  };
};
