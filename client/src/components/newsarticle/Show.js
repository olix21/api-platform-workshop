...
import {retrieve, reset} from '../../actions/newsarticle/show';
...
class Show extends Component {
  ...
  render() {
    ...
    return <div>
      ...
      {item && <Link to={`/news_articles/edit/${encodeURIComponent(item['@id'])}`}>
...
const mapStateToProps = (state) => {
  return {
    error: state.newsarticle.show.error,
    loading: state.newsarticle.show.loading,
    retrieved:state.newsarticle.show.retrieved,
