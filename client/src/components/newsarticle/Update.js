...
import { success } from '../../actions/newsarticle/create';
import { retrieve, update, reset } from '../../actions/newsarticle/update';
import { del, loading, error } from '../../actions/newsarticle/delete';
...
const mapStateToProps = (state) => {
  return {
    retrieveError: state.newsarticle.update.retrieveError,
    retrieveLoading: state.newsarticle.update.retrieveLoading,
    updateError: state.newsarticle.update.updateError,
    updateLoading: state.newsarticle.update.updateLoading,
    deleteError: state.newsarticle.del.error,
    deleteLoading: state.newsarticle.del.loading,
    created: state.newsarticle.create.created,
    deleted: state.newsarticle.del.deleted,
    retrieved: state.newsarticle.update.retrieved,
    updated: state.newsarticle.update.updated,
  };
};
